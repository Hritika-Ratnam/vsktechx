...
const CMSTechs = [
  { 
    key: "drupal", 
    label: "Drupal", 
    desc: "A free and open-source web content management system (CMS) written in PHP and released under the GNU General Public License.", 
    image: "/images/technologies/Drupal.png" 
  },
  { 
    key: "wordpress", 
    label: "WordPress", 
    desc: "WordPress.com offers everything you need to build and grow any website with managed WordPress hosting, unmetered bandwidth, security, and global CDN", 
  ...
  return (
    <>
      ...
      <div className="container py-5 tech-container" style={{ marginTop: 150 }}>
        <h1 className="mb-4 text-center" style={{ fontSize: "2.5rem" }}>CMS Technologies</h1>
            ...
            <div className="col-12 col-md-6 col-lg-4" key={tech.key}>
              <div className="card h-100 shadow-sm text-center p-4 d-flex flex-column tech-card">
                ...
                <div className="d-flex justify-content-center mt-auto">
                  <Link
                    href={`/technologies/cms/${tech.key}`}
