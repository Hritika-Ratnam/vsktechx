...
const PlatformsTechs = [
  { key: "salesforce", label: "Salesforce", desc: "", image: "/images/technologies/Salesforce.png" },
  { key: "servicenow", label: "Servicenow", desc: "", image: "/images/technologies/servicenow.png" },
];
  ...
  return (
    <>
      ...
      <div className="container py-5 tech-container" style={{ marginTop: 150 }}>
        <h1 className="mb-4 text-center" style={{ fontSize: "2.5rem" }}>Platforms</h1>
        <div className="row g-4 justify-content-center tech-card-container">
          {PlatformsTechs.map((tech) => (
            <div className="col-12 col-md-6 col-lg-4" key={tech.key}>
              <div className="card h-100 shadow-sm text-center p-4 d-flex flex-column tech-card">
                ...
                <div className="d-flex justify-content-center mt-auto">
                  <Link
                    href={`/technologies/platforms/${tech.key}`}
